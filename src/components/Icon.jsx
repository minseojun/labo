...
export const Icon = {
  ...
  Eye: (p) => <Base {...p}><path d="M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12Z" /><circle cx="12" cy="12" r="3" /></Base>,
  EyeOff: (p) => <Base {...p}><path d="M3 3l18 18" /><path d="M10.6 5.6A10 10 0 0 1 21.5 12s-1 1.8-2.9 3.5M6.3 6.3C4.4 7.6 3 9.8 2.5 12c0 0 3.5 6.5 9.5 6.5 1.3 0 2.5-.3 3.6-.8" /><path d="M9.5 9.9a3 3 0 0 0 4.2 4.2" /></Base>,
  Copy: (p) => <Base {...p}><rect x="8.5" y="8.5" width="12" height="12" rx="2" /><path d="M15.5 8.5V5.5A2 2 0 0 0 13.5 3.5h-8a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3" /></Base>,
  Trash: (p) => <Base {...p}><path d="M4 7h16M9 7V4.8A1.3 1.3 0 0 1 10.3 3.5h3.4A1.3 1.3 0 0 1 15 4.8V7M6.5 7l.8 12.3A2 2 0 0 0 9.3 21h5.4a2 2 0 0 0 2-1.7L18 7" /><path d="M10 11v6M14 11v6" /></Base>,
}
